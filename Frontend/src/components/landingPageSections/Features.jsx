...
const Features = () => {
    ...
    return (
        <div className="flex flex-col md:flex-row items-center justify-center md:gap-32 py-4 md:px-32 px-4 h-[60vh]">
            {/* Buttons/Labels */}
            ...
            {/* Details Box */}
            <div
                className="mt-4 md:mt-0 p-6 bg-[#6c63ff] text-white rounded-lg flex flex-col md:w-[650px] w-[450px]"
            >
                {features
