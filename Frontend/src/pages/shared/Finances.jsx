...
const {
  ...
  const filteredTransactions = activeTab === 0 
    ? transactions 
    : transactions.filter(t => t.status === (activeTab === 1 ? 'PAID' : 'Pending'));
  ...
  return (
    <div className='bg-background-color'>
      ...
      <div className=" bg-background-color mt-12">
        {/* Wave background */}
        
        <Container maxWidth="lg" className=" z-10 pt-8 pb-16 mt-8">
          {/* Withdraw Button */}
          {role=="Freelancer"&& <Box sx={{ mb: 4, display: 'flex', justifyContent: 'flex-start' }}>
            <Button 
              variant="contained" 
            ...
            <Grid container >
              <Grid item xs={6} sx={{ 
                ...
                <Typography variant="subtitle1" sx={{ fontWeight: 500, mb: 1 }}>
                  {role=="Freelancer"?"Available balance":"Previous Amounts"}
                </Typography>
                <Typography variant="h6" sx={{ fontWeight: 700 }}>
                  {role=="Freelancer"?`$ ${statistics?.availableBalance}`:`$ ${statistics?.previousBalance}`}
                </Typography>
              </Grid>
              <Grid item xs={6} sx={{ 
                p: 2, 
          ...
          <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', my: 5 }}>
            ...
            <Tabs 
              ...
              sx={{
                ...
                '& .Mui-selected': {
                  color: activeTab === 1 ? '#4caf50' : activeTab === 2 ? '#ff6b6b' : '#6c63ff'
                },
                '& .MuiTabs-indicator': {
                  backgroundColor: activeTab === 1 ? '#4caf50' : activeTab === 2 ? '#ff6b6b' : '#6c63ff'
                }
              }}
                ...
                >
                  ...
                  <Box 
                    sx={{ 
                      ...
                      px: 2, 
                      py: 0.5, 
                      bgcolor: transaction.status === 'PAID' ? '#4caf50' : '#ff6b6b',
                      color: 'white',
                  ...
                  <Box sx={{ display: 'flex', alignItems: 'center', mb: 1.5 }}>
                    ...
                    <Box>
                      ...
                      <Typography variant="caption" color="text.secondary" className='flex'>
                        <p>Jop Title</p>
                      </Typography>
                    </Box>
                  </Box>
